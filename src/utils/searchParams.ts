...
export function parseSearchParams(params: SearchParams): SearchFormValues {
  const parseRange = (val: string | undefined): { min: string | undefined; max: string | undefined } => {
  ...
  const parseDateRange = (val: string | undefined): { start: string | undefined; end: string | undefined } => {
